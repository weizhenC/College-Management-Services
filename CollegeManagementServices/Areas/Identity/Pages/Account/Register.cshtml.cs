...
namespace CollegeManagementServices.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            //add Role step2: dependancy injection
            ...
            IEmailSender emailSender)
        {
            ...
            //add Role step3: dependancy injection
        ...
        public class InputModel
        {
            ...
            //add roleSelection in the register page1
        ...
        {
            //add role step4: OnGet handler
            //to check if the role exists, if not exist, then create the role
            if (!_roleManager.RoleExistsAsync(Roles.Role_Staff).GetAwaiter().GetResult())
            {
                _roleManager.CreateAsync(new IdentityRole(Roles.Role_Staff)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(Roles.Role_Student)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(Roles.Role_Gamer)).GetAwaiter().GetResult();
            }

            //add roleSelection in the register page2
            Input = new()
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, Roles.Role_Student);
                    }
